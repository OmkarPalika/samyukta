...
const MOCK_EVENT_BENEFITS = [
  {
    title: "Networking",
    description:
      "Connect with other attendees, exchange ideas, and build professional connections."
  },
  {
    title: "Learning",
    description:
      "Gain insights from experts, participate in workshops, and learn from industry leaders."
  },
  {
    title: "Experiences",
    description:
      "Engage in hands-on workshops, participate in hackathons, and explore cutting-edge technologies."
  },
  {
    title: "Prizes",
    description:
      "Win exciting prizes and recognition for your contributions to the tech community."
  },
  {
    title: "Community",
    description:
      "Create lasting memories and build a supportive community of like-minded individuals."
  },
  {
    title: "Fun",
    description:
      "Have a blast while learning and networking with fellow tech enthusiasts."
  },
];
